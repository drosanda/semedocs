      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>$config</code> property contains about object from selected Seme Framework file </NuxtLink to="/4.0/configuration/">configuration</NuxtLink>.
              While accessing this property, every variables that existing on configuration will be converted as object.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>$config</code> property method from <NuxtLink to="/4.0/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="nav-bottom">
              <div class="nav-bottom-left">
                <nuxt-link to="/4.0/controller/cdn_url/" class="btn">
