      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The getJsContent method will <code>echo</code> the buffered view components that contain javascript from <NuxtLink to="/4.0/controller/putjscontent/">putJsContent</NuxtLink>.
