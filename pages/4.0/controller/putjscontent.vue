      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage of <code>putThemeContent</code> method from <NuxtLink to="/4.0/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="nav-bottom">
              ...
              <div class="nav-bottom-right">
                <nuxt-link to="/4.0/controller/putjsfooter/" class="btn">
                  putJsFooter
...
export default {
  ...
  data() {
    return {
      ...
      title: 'putJsContent Method',
      description: 'Learn more about putJsContent Method from SENE_Controller on Seme Framework version 4.0.0',
      breadcrumbs: [
        {
