      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The index method is an <code>abstract method</code> that <b>required</b> on each extended class from <NuxtLink to="/4.0/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink> and its derivatives.
              The index method are accessible from URL Request and then it will be a fallback method for empty URL request.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>index</code> method from <NuxtLink to="/4.0/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-07-24T19:26:00+07:00",
        "datePublished": "2021-07-24T19:26:00+07:00",
        "dateModified": "2021-07-24T19:26:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
