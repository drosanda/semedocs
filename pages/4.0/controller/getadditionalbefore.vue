      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>getAdditionalBefore</code> method is used to retrieve set of values that loaded through <NuxtLink to="/4.0/controller/loadcss/">loadCss <i class="fa fa-window-restore"></i></NuxtLink> method with <code>$utype</code> value equal to &#x22;before&#x22;.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage for <code>getAdditionalBefore</code> method from <NuxtLink to="/4.0/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="nav-bottom">
              ...
              <div class="nav-bottom-right">
                <nuxt-link to="/4.0/controller/getauthor/" class="btn">
                  getAuthor
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn more about getAdditionalAfter method on SENE_Controller class Seme Framework.',
      breadcrumbs: [
        {
