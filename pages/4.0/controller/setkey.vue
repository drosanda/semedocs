      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1>setKey Method</h1>
            <p>
              Method <code>setKey()</code> from SENE_Controller class allowed you to pass array of object or objects to save in session.
            </p>
...
export default {
  ...
  data() {
    return {
      ...
      title: 'setKey method',
      description: 'Learn more about setKey method from SENE_Controller on Seme Framework 4',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-07-14T19:14:00+07:00",
        "datePublished": "2021-07-14T19:15:00+07:00",
        "dateModified": "2021-07-14T19:19:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
