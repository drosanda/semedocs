          ...
          <div class="content">
            ...
            <div class="nav-bottom">
              ...
              <div class="nav-bottom-right">
                <nuxt-link to="/4.0/controller/getKeyword/" class="btn">
                  getKeyword
...
export default {
  ...
  data() {
    return {
      ...
      title: 'getKey method',
      description: 'Learn more about getKey method from SENE_Controller on Seme Framework version 4.0.0',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateModified": "2021-07-14T19:18:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
