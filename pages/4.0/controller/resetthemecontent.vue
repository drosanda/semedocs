    ...
    <div class="container">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul class="breadcrumbs">
          ...
          <li class="unavailable">resetThemeContent method</li>
        </ul>
      </nav>
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">resetThemeContent method</h1>
            <p>
              reset the teme content.
            </p>

            <h2>Basic Usage</h2>
            <p>The basic usage for resetThemeContent method is.</p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
                  <div class="close">
            ...
            <div class="nav-bottom">
              ...
              <div class="nav-bottom-right">
                <nuxt-link to="/4.0/controller/session/" class="btn">
                  session
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-07-13T13:29:00+07:00",
        "datePublished": "2021-07-13T13:30:00+07:00",
