      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              For loading WideImage into a controller class, simply using <NuxtLink to="/4.0/controller/lib/">lib <i class="fa fa-window-restore"></i></NuxtLink> method in a controller.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="nav-bottom">
              <div class="nav-bottom-left">
                <nuxt-link to="/4.0/library/seme_log/" class="btn">
