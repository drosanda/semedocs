    ...
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <ul>
              <li><NuxtLink to="/4.0/library/seme_log">Seme Log - Logger</NuxtLink></li>
              <li><NuxtLink to="/4.0/library/seme_email">Seme Email - Email Sender</NuxtLink></li>
            </ul>
          </div>
        </div>
      ...
      <div class="nav-bottom">
        ...
        <div class="nav-bottom-right">
          <nuxt-link to="/4.0/cli/" class="btn">
            CLI
...
export default {
  ...
  data() {
    return {
      ...
      title: 'Library',
      description: 'Learn more about Library on Seme Framework version 4.0.2',
      breadcrumbs: [
        {
