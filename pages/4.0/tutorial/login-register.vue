    ...
    <div class="container">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul class="breadcrumbs">
          ...
          <li class="unavailable">Login and Register</li>
        </ul>
      </nav>
      <div>
        <div class="column">
          <div class="content">
            <h1 class="">Login and Register Implementation</h1>
            <p>
              On this tutorial we will create login page the authentication process using mysql database.
            </p>

            <h2>Before Started</h2>
            <p>
              Make sure you have already run MySQL and then have create a database called <code>seme_framework</code> which will used on this tutorial.
              And then please read <NuxtLink to="/4.0/configuration/db-connection" target="_blank">database connection configuration <i class="fa fa-window-restore"></i></NuxtLink> and make sure has correct configuration.
            </p>

            <h2>Import Database</h2>
            <p>
              First we need to import for storing user data that will be used for login, the table name called <code>b_user</code>.
              
              Copy paste SQL code below and run it ot <b>PhpMyAdmin</b> to create the table.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
SET FOREIGN_KEY_CHECKS=1;
            ...
            <h2>Create model file for <code>b_user</code> table</h2>
            <p>
            ...
            <p>
              ...
              Supaya flash message ini tersedia pada setiap controller yang ada didalam sistem yang kita buat, maka kita akan membuat sebuah <NuxtLink to="/4.0/core/controller" target="_blank">Core Controller<i class="fa fa-window-restore"></i></NuxtLink> dan menambahkan metode untuk flash message.
            </p>
            <p>
...
&#x3C;/main&#x3E;
            ...
            <p>
              ...
              Sebelumnya pada controller ini, file model <code>b_user_model.php</code> akan dipanggil melalui metode <NuxtLink to="/4.0/controller/load" target="_blank">load <i class="fa fa-window-restore"></i></NuxtLink> pada constructor controller ini supaya controller memiliki kemampuan untuk menyimpan data kedalam tabel <code>b_user</code>.
            </p>
            <p>
  ...
  public function proses(){
    ...
    if(strlen($email)&#x3E;=4 &#x26;&#x26; strlen($password)&#x3E;=5){
      ...
      $this-&#x3E;index();
            ...
            <p>
              Pada tutorial sebelumnya dalam <NuxtLink to="/4.0/tutorial/navigation" target="_blank">pembuatan Navigation <i class="fa fa-window-restore"></i></NuxtLink>,
...
&#x3C;/ul&#x3E;
      ...
      <div class="nav-bottom">
        ...
        <div class="nav-bottom-right">
          <nuxt-link to="/4.0/tutorial/send-email" class="btn">
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Login and Register Implementation',
      description: 'Learn how to create login and register in Seme Framework 4.',
  ...
  return [
    ...
    },
    {
      ...
      "dateCreated": "2025-01-15T22:17:01+07:00",
      "datePublished": "2025-01-15T22:17:01+07:00",
      "dateModified": "2025-01-15T22:17:01+07:00",
      "author": {
        "@type": "Person",
        "gender": "Male",
