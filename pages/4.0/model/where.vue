...
export default {
  ...
  data (){
    return {
      ...
      title: 'Where Method',
      description: 'Learn where method from $db property on SENE_Model class for Seme Framework 4',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2020-08-08T08:43:33+07:00",
        "datePublished": "2020-08-08T08:43:33+07:00",
        "dateModified": "2020-08-08T08:43:33+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
