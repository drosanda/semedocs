        ...
        <div class="column">
          <div class="content">
            ...
            <p>
              ...
              This method is part from <NuxtLink to="/4.0/model/#query_builder">Query Builder <i class="fa fa-window-restore"></i></NuxtLink> methods.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>insert_multi</code> method from <code>$db</code> property on <NuxtLink to="/4.0/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
