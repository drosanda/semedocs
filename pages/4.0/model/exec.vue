    ...
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>exec</code> method from <code>$db</code> property on <NuxtLink to="/4.0/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="message is-warning">
              <div class="message-body">
                ...
                <p>Please use <NuxtLink to="/4.0/model/query/">Query Method<i class="fa fa-window-restore"></i></NuxtLink> for collecting the result from raw SQL.</p>
              </div>
            </div>
      ...
      <div class="nav-bottom">
        ...
        <div class="nav-bottom-right">
          <nuxt-link to="/4.0/model/from/" class="btn">
            From method
