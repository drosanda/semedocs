      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>union_order_by</code> method from <code>$db</code> property on <NuxtLink to="/4.0/model/#SENE_Model" target="_blank">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="nav-bottom">
              ...
              <div class="nav-bottom-right">
                <nuxt-link to="/4.0/model/union_select/" class="btn">
                  Union Select Method
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateModified": "2023-01-12T09:34:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
