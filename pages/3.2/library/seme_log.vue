    ...
    <div class="container">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul class="breadcrumbs">
          ...
          <li class=""><NuxtLink to="/3.2/library">Library</NuxtLink></li>
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">Seme Log Library</h1>
            <p>The <code>seme_log</code> library is for logging some text or result into file log. Seme log will create and put new file seme.log in root project or in app/cache/seme.log depending directory access on your script.</p>
            <hr>
            <h2>How to use</h2>
            ...
            <p>If you used *nix Operating System, you can <code>tail -f seme.log</code> for realtime view log.</p>
