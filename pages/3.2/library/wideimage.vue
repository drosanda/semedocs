      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              For loading WideImage into a controller class, simply using <NuxtLink to="/3.2/controller/lib/">lib <i class="fa fa-window-restore"></i></NuxtLink> method in a controller.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
  ...
  export default {
    ...
    data() {
      return {
        ...
        description: 'Learn more about WideImage library with Seme Framework 3.2.5',
        breadcrumbs: [
          {
