  ...
  <div class="section">
      ...
      <div class="columns">
        <div class="column">
          ...
          <p>
            ...
            This layout file can be loaded by using <NuxtLink to="/3.2/controller/loadlayout/">loadLayout()</NuxtLink> method from SENE_Controller class.
          </p>
          <p>
          ...
          <p>
            ...
            This file are processed by <NuxtLink to="/3.2/controller/constructor/">SENE_Controller class constructor</NuxtLink> and outputed by <NuxtLink to="/3.2/controller/getadditional/">getAdditional()</NuxtLink>.
          </p>
          ...
          <p>
            ...
            This file are processed by <NuxtLink to="/3.2/controller/constructor/">SENE_Controller class constructor</NuxtLink> and outputed by <NuxtLink to="/3.2/controller/getjsfooter/">getJsFooter()</NuxtLink>.
          </p>
    ...
    <div class="nav-bottom">
      <div class="nav-bottom-left">
        <nuxt-link to="/3.2/view/" class="btn">
          <i class="fa fa-chevron-left"></i>
          View
        </nuxt-link>
      </div>
      <div class="nav-bottom-right">
        <nuxt-link to="/3.2/view/layout/" class="btn">
          View: Layout
  ...
  data (){
    return {
      ...
      breadcrumbs: [
        ...
        {
          url: (process.env.BASE_URL || 'http://localhost:3001')+'/3.2/view',
          text: 'View'
        }
      ],
    }
