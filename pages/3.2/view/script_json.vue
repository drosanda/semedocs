  ...
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">The <code>script.json</code> File</h1>
            <p>
            ...
            <p>
              The script.json file processed by <NuxtLink to="/3.2/controller/constructor/">SENE_Controller class constructor</NuxtLink> and outputed by <NuxtLink to="/3.2/controller/getjsfooter/">getJsFooter()</NuxtLink>.
            </p>
      ...
      <div class="nav-bottom">
        <div class="nav-bottom-left">
          <nuxt-link to="/3.2/view/cdn_url/" class="btn">
            <i class="fa fa-chevron-left"></i>
            cdn_url
          </nuxt-link>
        </div>
        <div class="nav-bottom-right">
          <nuxt-link to="/3.2/view/theme_json/" class="btn">
            theme.json
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateModified": "2021-07-18T13:06:24+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
