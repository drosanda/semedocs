    ...
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              Seme Framework support <code>{{cdn_url}}</code> keyword for replacing the keyword with <code>$cdn_url</code> value in <NuxtLink to="/3.2/configuration/">Seme Framework Configuration</NuxtLink>.
            </p>
            ...
            <p>
              This <code>{{cdn_url}}</code> keyword only processed on <code>theme.json</code> and <code>script.json</code> files.
            </p>

            <h2 class="">Fallback</h2>
            <p>
              If the value from configuration is empty, the <code>$base_url</code> value from Seme Framework configuration will be used as default value.
            </p>
      ...
      <div class="nav-bottom">
        <div class="nav-bottom-left">
          <nuxt-link to="/3.2/view/base_url/" class="btn">
