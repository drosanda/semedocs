      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              Seme Framework support <code>{{base_url}}</code> keyword for replacing the keyword with <code>$site</code> value in <NuxtLink to="/3.2/configuration/">Seme Framework Configuration</NuxtLink>.
            </p>
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn how to use The {{base_url}} keyword on Seme Framework 3.2.5.',
      breadcrumbs: [
        {
