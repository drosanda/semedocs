      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>union_limit</code> method from <code>$db</code> property on <NuxtLink to="/3.2/model/#SENE_Model" target="_blank">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
