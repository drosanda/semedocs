      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>get</code> method is a part of the <NuxtLink to="/3.2/database/query-builder">Query Builder <i class="fa fa-window-restore"></i></NuxtLink> which is useful for getting <u>all results</u> from the query builder that has been compiled.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>get</code> method from <code>$db</code> property on <NuxtLink to="/3.2/model/#SENE_Model" target="_blank">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
  ...
  export default {
    ...
    data (){
      return {
        ...
        title: 'Get Method',
        description: 'Learn about get method from $db property on SENE_Model class for Seme Framework version 3.2.x.',
        breadcrumbs: [
          {
