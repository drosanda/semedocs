      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>composite_create</code> method purpose is for generating key pair array for a parameter value in <NuxtLink to="/3.2/model/join_composite/#compositeObject">join_composite <i class="fa fa-window-restore"></i></NuxtLink> method.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>composite_create</code> method from <code>$db</code> property on <NuxtLink to="/3.2/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn more about composite_create method on SENE_Model class Seme Framework version 3.2.x.',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-14T19:04:00+07:00",
        "datePublished": "2021-08-14T19:04:00+07:00",
        "dateModified": "2021-08-14T19:04:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
