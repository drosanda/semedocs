      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>For basic usage, Seme Framework has basic where method called <NuxtLink to="/3.2/model/where/">where method</NuxtLink>.</p>
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn where_as method from $db property on SENE_Model class for Seme Framework version 3.2.x',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-14T14:06:00+07:00",
        "datePublished": "2021-08-14T14:06:00+07:00",
        "dateModified": "2021-08-14T14:06:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
