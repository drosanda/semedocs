...
&#x9; parent::__construct();
  ...
  public function update(){
    ...
    $this-&#x3E;db-&#x3E;update_as($ths-&#x3E;tbl,$du);
      ...
      <div class="columns">
        <div class="column">
          <b-button tag="router-link" to="/3.2/model/select" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
            Model::select
          </b-button>
        </div>
        <div class="column is-2">&nbsp;</div>
        <div class="column">
          <b-button tag="router-link" to="/3.2/model/update" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
            Model::update
          </b-button>
        </div>
      </div>
