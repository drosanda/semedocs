    ...
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>update_as</code> method from <code>$db</code> property on <NuxtLink to="/3.2/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
      ...
      <div class="nav-bottom">
        <div class="nav-bottom-left">
          <nuxt-link to="/3.2/model/select" class="btn">
            <i class="fa fa-chevron-left"></i>
            Select Method
          </nuxt-link>
        </div>
        <div class="nav-bottom-right">
          <nuxt-link to="/3.2/model/update" class="btn">
            Update Method
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn update_as method from $db property on SENE_Model class for Seme Framework 3.2.x',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-11T19:35:34+07:00",
        "datePublished": "2021-08-11T19:35:34+07:00",
        "dateModified": "2021-08-11T19:36:25+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
