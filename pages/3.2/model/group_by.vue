      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>group_by</code> method is part of <NuxtLink to="/3.2/database/query-builder">Query Builder <i class="fa fa-window-restore"></i></NuxtLink> method for grouping result set by running <code>GROUP BY</code> SQL command.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>group_by</code> method from <code>$db</code> property on <NuxtLink to="/3.2/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn about group_by method from $db property on SENE_Model class for Seme Framework version 3.2.x.',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-12T19:14:20+07:00",
        "datePublished": "2021-08-12T19:14:20+07:00",
        "dateModified": "2021-08-12T19:14:20+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
