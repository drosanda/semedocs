...
export default {
  ...
  data (){
    return {
      ...
      title: 'Insert Method',
      description: 'Learn more about insert method from $db property on SENE_Model class for Seme Framework version 3.2.x',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-12T20:21:22+07:00",
        "datePublished": "2021-08-12T20:21:22+07:00",
        "dateModified": "2021-08-12T20:21:22+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
