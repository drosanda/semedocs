...
<li class=""><NuxtLink to="/3.2">3.2.x</NuxtLink></li>
        ...
        <div class="content">
          <h1 class="">Insert Batch Method</h1>
					<p>Insert Batch method is alias of insert_multi method. Insert batch is part of database class builder for inserting multiple data into a table. Is alias of <NuxtLink to="/3.2/model/insert_multi/">Insert Multi method</NuxtLink>.</p>
					<h2>Parameters</h2>
