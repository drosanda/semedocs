        ...
        <div class="column">
          <div class="content">
            ...
            <p>
              ...
              This method only work if <NuxtLink to="/3.2/controller/getjsready" target="_blank">getJsReady <i class="fa fa-window-restore"></i></NuxtLink> method called inside document ready block in a <NuxtLink to="/3.2/view/#view_layout_example" target="_blank">View Layout</NuxtLink>.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage for <code>putJsReady</code> method from <NuxtLink to="/3.2/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <p>
              ...
              Learn more about <NuxtLink to="/3.2/view/theme#specific_js">javascript specific view component <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            ...
            <h2>Example Usage</h2>
            <p>Here is the basic example for <code>putJsReady</code> method.</p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
                  <div class="close">
            ...
            <p>So, the <code>front</code> theme and <code>home_bottom.php</code> layout should be existed on the directory structure.</p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
                  <div class="close">
            ...
            <h3>Full Example with $data usage</h3>
            <p>Here is the full example for <code>putJsReady</code> method using $data and its content.</p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
                  <div class="close">
...
export default {
  ...
  data() {
    return {
      ...
      suffix: ' - Seme Framework 3.2.x',
      title: 'putJsReady Method',
      description: 'Learn more about putJsReady Method from SENE_Controller on Seme Framework 3.2.x',
      breadcrumbs: [
        {
