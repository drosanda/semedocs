      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The controller class must be <code>extends</code> from <NuxtLink to="/3.2/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink>.
              But, If using <code>* core controller</code>  as parent class, the core controller class must be <code>extends</code> from <NuxtLink to="/3.2/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            ...
            <p>
              ...
              But, Seme Framework has support for <NuxtLink to="/3.2/configuration/routes/">URI Controller Remapping</NuxtLink>.
            </p>
