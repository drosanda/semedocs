      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>getAdditionalAfter</code> method is used to retrieve set of values that loaded through <NuxtLink to="/3.2/controller/loadcss/">loadCss <i class="fa fa-window-restore"></i></NuxtLink> method with <code>$utype</code> value equal to &#x22;after&#x22;.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage for <code>getAdditionalAfter</code> method from <NuxtLink to="/3.2/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="nav-bottom">
              <div class="nav-bottom-left">
                <nuxt-link to="/3.2/controller/getadditional/" class="btn">
