...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn more about how to use Command Line Interface (CLI) on Seme Framework version 3.2.5 through this documentation.',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateModified": "2021-06-25T16:58:14+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
