      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The script.json file processed by <NuxtLink to="/4.0.0/controller/constructor/">SENE_Controller class constructor</NuxtLink> and outputed by <NuxtLink to="/4.0.0/controller/getjsfooter/">getJsFooter()</NuxtLink>.
            </p>
