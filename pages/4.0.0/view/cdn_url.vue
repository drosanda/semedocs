      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              Seme Framework support <code>{{cdn_url}}</code> keyword for replacing the keyword with <code>$cdn_url</code> value in <NuxtLink to="/4.0.0/configuration/">Seme Framework Configuration</NuxtLink>.
            </p>
