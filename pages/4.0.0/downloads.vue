  ...
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="buttons">
            <b-button tag="router-link" to="/4.0.0/requirements/" type="is-link" icon-pack="fa" icon-left="chevron-left">
                Requirements
            </b-button>
            <b-button tag="router-link" to="/4.0.0/configuration/" type="is-link" icon-pack="fa" icon-right="chevron-right">
                Configuration
            </b-button>
          </div>
        </div>
