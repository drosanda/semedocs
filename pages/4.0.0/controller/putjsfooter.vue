    ...
    <div class="container">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul class="breadcrumbs">
          ...
          <li class="unavailable">putJsFooter Method</li>
        </ul>
      </nav>
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>Here is the basic usage of <code>putJsFooter</code>.</p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
                  <div class="close">
            ...
            <h2>Example</h2>
            <p>Here is the example for <code>putJsFooter</code> method.</p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
                  <div class="close">
            ...
            <p>So, the <code>col-1</code> theme, <code>col-1</code> layout and <code>home_bottom.php</code> content should be existed on the directory structure.</p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
                  <div class="close">
...
export default {
  ...
  data() {
    return {
      ...
      description: 'Learn more about putJsFooter method from SENE_Controller on Seme Framework version 4.0.0',
      breadcrumbs: [
        {
