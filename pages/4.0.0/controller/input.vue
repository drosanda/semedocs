...
if($sc-&#x3E;status == 200){
  ...
  ....
      ...
      <div class="columns">
        <div class="column">
          <div class="buttons">
            <b-button tag="router-link" to="/4.0.0/controller/lib" type="is-link" icon-pack="fa" icon-left="chevron-left" class="">
              Lib Method
            </b-button>
            <b-button tag="router-link" to="/4.0.0/controller/setTheme" type="is-link" icon-pack="fa" icon-right="chevron-right" class="">
              setTheme Method
            </b-button>
          </div>
        </div>
