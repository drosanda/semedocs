      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              Seme Framework comes with builtin session manager which stored to <code>$_SESSION</code> array with randomize string that define through <NuxtLink to="/4.0.0/configuration/session/">configuration</NuxtLink>.
            </p>
