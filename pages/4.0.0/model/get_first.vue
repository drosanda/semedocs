...
<li class=""><NuxtLink to="/4.0.0/">4.0.0</NuxtLink></li>
  ...
  public function getByIdArrayDebugQuery($id){
    ...
    return $this->db->get_first('array',1);
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/get" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::get
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/insert" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::insert
            </b-button>
          </div>
        </div>
