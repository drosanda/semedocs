...
<li class=""><NuxtLink to="/4.0.0/">4.0.0</NuxtLink></li>
        ...
        <div class="content">
          <h1 class="">Last ID Method</h1>
					...
					<pre>$this->db->lastId(): integer</pre>
          <h2>Example usage</h2>
  ...
  public function insert($di){
    ...
    return $this->db->lastId();
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/query" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::query
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/view" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              View
            </b-button>
          </div>
        </div>
