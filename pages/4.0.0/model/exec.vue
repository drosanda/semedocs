...
<li class=""><NuxtLink to="/4.0.0/">4.0.0</NuxtLink></li>
        ...
        <div class="content">
          ...
          <p>Query method has 1 required parameter.</p>
					<pre>$this->db->query(string $sql): boolean</pre>
          <h3>$sql</h3>
    ...
    $sql = 'UPDATE products SET is_published =0 WHERE DATE(date_created) < DATE("2019-01-01")';
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/delete" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::delete
            </b-button>
          </div>
