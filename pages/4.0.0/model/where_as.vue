...
<li class=""><NuxtLink to="/4.0.0/">4.0.0</NuxtLink></li>
	...
	CLOSEBRACKET
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/where" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::where
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/between" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::between
            </b-button>
          </div>
        </div>
