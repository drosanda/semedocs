...
<li class=""><NuxtLink to="/4.0.0/">4.0.0</NuxtLink></li>
	...
	CLOSEBRACKET
					...
					<p>For basic usage, Seme Framework has basic where method called <NuxtLink to="model-where">where_as method</NuxtLink>.</p>
        </div>
      </div>
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/where" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::where
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/between" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::between
            </b-button>
          </div>
        </div>
