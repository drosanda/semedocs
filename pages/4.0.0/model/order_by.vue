  ...
  public function getLatest($di){
    ...
    return $this->db->get();
        ...
        <div class="columns">
          ...
          <div class="column">
            <b-button tag="router-link" to="/4.0.0/model/limit" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::limit
            </b-button>
          </div>
        </div>
...
<script>
  export default {
    ...
    data() {
      return {
        title: 'Model::order_by - Seme Framework v4.0.0'
      }
    },
    head() {
      return {
