  ...
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">Union Create Method</h1>
            <p>
              The <code>union_create</code> method purpose is for creating union query from current Query Builder.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>union_create</code> method from <code>$db</code> property on <NuxtLink to="/4.0.0/model/#SENE_Model" target="_blank">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <h2>Example</h2>
            <p>
              On this example will show the implementation of <code>union_create</code> method.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="nav-bottom">
              ...
              <div class="nav-bottom-right">
                <nuxt-link to="/4.0.0/model/union_flush/" class="btn">
                  Union Flush Method
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Union Create Method',
      description: 'Learn about union_create method from $db property on SENE_Model class for Seme Framework 4.',
      breadcrumbs: [
        {
