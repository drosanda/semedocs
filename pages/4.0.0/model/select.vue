...
class Blog extends Sene_Controller{
  ...
  public function detail($id){
    ...
    $this-&#x3E;debug($blog);
          ...
          <div class="columns">
            <div class="column">
              <b-button tag="router-link" to="/4.0.0/model/" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
                Model
              </b-button>
            </div>
            <div class="column is-2">&nbsp;</div>
            <div class="column">
              <b-button tag="router-link" to="/4.0.0/model/select_as" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
                Model::select_as
              </b-button>
            </div>
          </div>
