...
class Blog_Model extends SENE_Model{
  ...
  <div class="message-body">
      ...
      <div class="columns">
        <div class="column">
          <div class="buttons">
            <b-button tag="router-link" to="/4.0.0/model/order_by" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::order_by
            </b-button>
            <b-button tag="router-link" to="/4.0.0/model/get" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::get
            </b-button>
          </div>
        </div>
