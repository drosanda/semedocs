      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>update_as</code> method is like <NuxtLink to="/4.0.0/model/update/">update method <i class="fa fa-window-restore"></i></NuxtLink> but with <b>unescaped</b> key value pair.
              ...
              This method is available from SEME Framework version 4.0.2.
            </p>
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>update_as</code> method from <code>$db</code> property on <NuxtLink to="/4.0.0/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
