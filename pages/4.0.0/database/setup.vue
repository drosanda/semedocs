    ...
    <div class="container">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul class="breadcrumbs">
          ...
          <li class="unavailable">Setup</li>
        </ul>
      </nav>
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1>Setup the database connection</h1>
            <p>On this database we will learn about importing database and configuring database connection for Seme Framework.</p>

            <h2>Create the database using PhpMyAdmin</h2>
            ...
            <h2>Import the example database</h2>
...
...
  ...
  <div class="message-body">
      ...
      <div class="columns">
        <div class="column">
          <div class="buttons">
            <b-button tag="router-link" to="/4.0.0/database/" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Database
            </b-button>
            <b-button tag="router-link" to="/4.0.0/database/quick-start/" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Quick Start
            </b-button>
          </div>
        </div>
