      ...
      <div class="">
        <div class="column">
          <div class="content">
            ...
            <p>
              Before starting the tutorial, you have to do which is described on the <NuxtLink to="/4.0.0/requirements" target="_blank">requirements <i class="fa fa-window-restore"></i></NuxtLink> first.
            ...
            <p>
              We assumed that you put Seme Framework which is described In the <NuxtLink to="/4.0.0/downloads" target="_blank">Download &amp; Install <i class="fa fa-window-restore"></i></NuxtLink> page.
            ...
            <div class="message is-success">
              <div class="message-body">
                <p>This tutorial using <a href="https://materializecss.com/" target="_blank">materializeCSS <i class="fa fa-external-link"></i></a> as the CSS Library.</p>
              </div>
            </div>
            ...
            <p>
              Learn more about <NuxtLink to="/4.0.0/view/theme_json/" target="_blank">theme.json <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            ...
            <p>
              Learn more about <NuxtLink to="/4.0.0/view/script_json/" target="_blank">script.json <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
