<template>
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <b-button tag="router-link" to="/4.0.0/tutorial/introduction" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
            Tutorial: Introduction
          </b-button>
        </div>
        <div class="column is-2">&nbsp;</div>
        <div class="column">
          <b-button tag="router-link" to="/4.0.0/uri_routing/admin" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
            Uri Routing: Admin
          </b-button>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      title: 'URI Routing - Seme Framework v4.0.0'
    }
  },
  head() {
    return {
