  ...
  <div class="section">
      ...
      <div class="columns">
        <div class="column">
          ...
          <p>
            ...
            This layout file can be loaded by using <NuxtLink to="/3.2.1/controller/loadlayout/">loadLayout()</NuxtLink> method from SENE_Controller class.
          </p>
          <p>
          ...
          <p>
            ...
            This file are processed by <NuxtLink to="/3.2.1/controller/constructor/">SENE_Controller class constructor</NuxtLink> and outputed by <NuxtLink to="/3.2.1/controller/getadditional/">getAdditional()</NuxtLink>.
          </p>
          ...
          <p>
            ...
            This file are processed by <NuxtLink to="/3.2.1/controller/constructor/">SENE_Controller class constructor</NuxtLink> and outputed by <NuxtLink to="/3.2.1/controller/getjsfooter/">getJsFooter()</NuxtLink>.
          </p>
    ...
    <div class="nav-bottom">
      ...
      <div class="nav-bottom-right">
        <nuxt-link to="/3.2.1/view/layout/" class="btn">
          View: Layout
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Theme',
      description: 'Learn how to create a theme using Seme Framework 3.2.3.',
      breadcrumbs: [
        {
