      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>limit</code> method from <code>$db</code> property on <NuxtLink to="/3.2.1/model/#SENE_Model" target="_blank">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Limit Method',
      description: 'Learn about limit method from $db property on SENE_Model class for Seme Framework 3.2.5.',
      breadcrumbs: [
        {
