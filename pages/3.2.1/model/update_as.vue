      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>This methode is available from SEME Framework version 3.2.2.</p>
...
export default {
  ...
  data (){
    return {
      ...
      suffix: ' - Seme Framework v3.2.x Documentation',
      title: 'Model::update_as method',
      description: 'Learn more about update_as method from Seme Framework version 3.2.x.'
    }
  },
  head() {
    return {
