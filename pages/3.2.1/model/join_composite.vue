        ...
        <div class="column">
          <div class="content">
            ...
            <p>
              ...
              This method are suitable by combining with <NuxtLink to="/3.2.1/model/composite_create/">composite_create</NuxtLink> method.
            </p>
            ...
            <div class="nav-bottom">
              <div class="nav-bottom-left">
                <nuxt-link to="/3.2.1/model/insert/" class="btn">
                  <i class="fa fa-chevron-left"></i>
                  insert Method
                </nuxt-link>
              </div>
              <div class="nav-bottom-right">
                <nuxt-link to="/3.2.1/model/join/" class="btn">
                  join Method
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn more about join_composite method from $db property on SENE_Model class for Seme Framework 3.2.1.',
      breadcrumbs: [
        {
