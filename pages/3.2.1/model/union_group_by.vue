    ...
    <div class="container">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul class="breadcrumbs">
          ...
          <li class="unavailable">Union Group By</li>
        </ul>
      </nav>
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">Union Group By Method</h1>
            <p>
              The <code>union_group_by</code> method is part of query builder method for grouping result set by running <code>Union Group By</code> SQL command.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>union_group_by</code> method from <code>$db</code> property on <NuxtLink to="/3.2.1/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <h3>$expression</h3>
            <p>The <b>$expression</b> value can be single column name or can be SQL Function that compatible with <code>Union Group By</code> command.</p>

            <h2>Example</h2>
            <p>
              Here is the source code implementation of <code>union_group_by</code> method in a model class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn about union_group_by method from $db property on SENE_Model class for Seme Framework 3.2.5.',
      breadcrumbs: [
        {
