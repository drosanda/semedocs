      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>The following code loads and initializes the database class based on your <NuxtLink to="/3.2.1/config/database">configuration</NuxtLink> settings. Here the steps:</p>
            <ol>
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Quick Start',
      description: 'Learn more about quick start database Reference on Seme Framework 3.2.1.',
      breadcrumbs: [
        {
        ...
        {
          url: (process.env.BASE_URL || 'http://localhost:3001')+'/3.2.1/database',
          text: 'Database'
        }
      ]
    }
