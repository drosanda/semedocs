      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              Seme Framework comes with builtin session manager which stored to <code>$_SESSION</code> array with randomize string that define through <NuxtLink to="/3.2.1/configuration/session/">configuration</NuxtLink>.
            </p>
            ...
            <div class="nav-bottom">
              <div class="nav-bottom-left">
                <nuxt-link to="/3.2.1/controller/resetthemecontent/" class="btn">
                  <i class="fa fa-chevron-left"></i>
                  resetThemeContent
                </nuxt-link>
              </div>
              <div class="nav-bottom-right">
                <nuxt-link to="/3.2.1/controller/setauthor/" class="btn">
                  setAuthor
