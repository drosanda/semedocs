    ...
    <div class="container">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul class="breadcrumbs">
          ...
          <li class="unavailable">Handling Form Input</li>
        </ul>
      </nav>
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>$input</code> property from <NuxtLink to="/3.2.1/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink> is an object from <code>SENE_Input</code> class.
            </p>
            ...
            <h3>Basic Usage</h3>
            <p>
              This is the basic usage <code>get</code> method from <NuxtLink to="/3.2.1/controller/input/#SENE_Input">$input <i class="fa fa-window-maximize"></i></NuxtLink> property on <NuxtLink to="/3.2.1/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <h3>Basic Usage</h3>
            <p>
              This is the basic usage <code>post</code> method from <NuxtLink to="/3.2.1/controller/input/#SENE_Input">$input <i class="fa fa-window-maximize"></i></NuxtLink> property on <NuxtLink to="/3.2.1/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <h3>Basic Usage</h3>
            <p>
              This is the basic usage <code>request</code> method from <NuxtLink to="/3.2.1/controller/input/#SENE_Input">$input <i class="fa fa-window-maximize"></i></NuxtLink> property on <NuxtLink to="/3.2.1/controller/#SENE_Controller">SENE_Controller <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <ul>
              <li>Library <NuxtLink to="/3.2.1/library/seme_log/">SEME_Log</NuxtLink>,</li>
              <li>Library <NuxtLink to="/3.2.1/library/wideimage/">WideImage</NuxtLink>,</li>
...
export default {
  ...
  data() {
    return {
      ...
      description: 'Learn input property (SENE_Input) from SENE_Controller class on Seme Framework version 3.2.1',
      breadcrumbs: [
        {
        ...
        {
          url: (process.env.BASE_URL || 'http://localhost:3001')+'/3.2.1/controller',
          text: 'Controller'
        }
      ],
    }
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateModified": "2021-07-12T22:04:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
