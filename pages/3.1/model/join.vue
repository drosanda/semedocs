      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>join</code> method from <code>$db</code> property on <NuxtLink to="/3.1/model/#SENE_Model" target="_blank">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Join Method',
      description: 'Learn more about join method from $db property on SENE_Model class for Seme Framework version 3.1.',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-14T08:35:00+07:00",
        "datePublished": "2021-08-14T08:35:00+07:00",
        "dateModified": "2021-08-14T08:35:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-14T09:52:00+07:00",
        "datePublished": "2021-08-14T09:52:00+07:00",
        "dateModified": "2021-08-14T09:52:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
          "name": "Daeng Rosanda, S.Kom",
