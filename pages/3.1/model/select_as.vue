    ...
    <div class="container">
      <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul class="breadcrumbs">
          ...
          <li class="unavailable">select_as</li>
        </ul>
      </nav>
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>select_as</code> method from <code>$db</code> property on <NuxtLink to="/3.1/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn select_as method from $db property on SENE_Model class for Seme Framework version 3.1.5',
      breadcrumbs: [
        {
