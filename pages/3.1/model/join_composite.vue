        ...
        <div class="column">
          <div class="content">
            ...
            <p>
              ...
              This method are suitable by combining with <NuxtLink to="/3.1/model/composite_create/">composite_create</NuxtLink> method.
            </p>
            ...
            <div class="message is-info">
              <div class="message-body">
                <p>This method available from Seme Framework version &#x3E;= 3.1.5</p>
              </div>
            </div>
            ...
            <div class="nav-bottom">
              <div class="nav-bottom-left">
                <nuxt-link to="/3.1/model/insert/" class="btn">
                  <i class="fa fa-chevron-left"></i>
                  insert Method
                </nuxt-link>
              </div>
              <div class="nav-bottom-right">
                <nuxt-link to="/3.1/model/join/" class="btn">
                  join Method
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn more about join_composite method from $db property on SENE_Model class for Seme Framework version 3.1.x.',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-12T19:32:00+07:00",
        "datePublished": "2021-08-12T19:32:00+07:00",
        "dateModified": "2021-08-12T19:34:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
