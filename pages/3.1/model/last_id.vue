      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>last_id</code> method purpose is for getting postive integer value if an ID has generated automatically from <code>MySQL Auto Increment</code> feature.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>last_id</code> method from <code>$db</code> property on <NuxtLink to="/3.1/model/#SENE_Model" target="_blank">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn more about last_id method from $db property on SENE_Model class for Seme Framework version 3.1.x',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-14T09:14:00+07:00",
        "datePublished": "2021-08-14T09:14:00+07:00",
        "dateModified": "2021-08-14T09:14:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
