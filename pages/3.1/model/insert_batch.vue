      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>insert_batch</code> method is an alias from <NuxtLink to="/3.1/model/insert_multi">Insert Multi <i class="fa fa-window-restore"></i></NuxtLink> method.
              This method purpose is for inserting multiple rows data into a table.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>insert_batch</code> method from <code>$db</code> property on <NuxtLink to="/3.1/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      name: 'Seme Framework v.3.1',
      suffix: ' - Seme Framework 3.1',
      title: 'Insert Batch Method',
      description: 'Learn about insert_batch method from $db property on SENE_Model class for Seme Framework version 3.1.x.',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-12T19:24:53+07:00",
        "datePublished": "2021-08-12T19:24:53+07:00",
        "dateModified": "2021-08-12T19:24:53+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
