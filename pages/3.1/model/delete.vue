      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              The <code>delete</code> method is a part of the <NuxtLink to="/3.1/database/query-builder">Query Builder <i class="fa fa-window-restore"></i></NuxtLink> which is useful for deleting data in a table by execute <code>DELETE</code> SQL command.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>delete</code> method from <code>$db</code> property on <NuxtLink to="/3.1/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Delete Method',
      description: 'Learn about delete method from $db property on SENE_Model class for Seme Framework 3.1.x',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-14T18:37:28+07:00",
        "datePublished": "2021-08-14T18:37:28+07:00",
        "dateModified": "2021-08-14T18:37:28+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
