...
export default {
  ...
  data (){
    return {
      ...
      title: 'Where Method',
      description: 'Learn where method from $db property on SENE_Model class for Seme Framework version 3.1.x',
      breadcrumbs: [
        {
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-14T13:29:00+07:00",
        "datePublished": "2021-08-14T13:29:00+07:00",
        "dateModified": "2021-08-14T13:29:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
