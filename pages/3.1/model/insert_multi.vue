        ...
        <div class="column">
          <div class="content">
            ...
            <p>
              ...
              This method is part from <NuxtLink to="/3.1/model/#query_builder">Query Builder <i class="fa fa-window-restore"></i></NuxtLink> methods.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>insert_multi</code> method from <code>$db</code> property on <NuxtLink to="/3.1/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Learn more insert_multi method from $db property on SENE_Model class for Seme Framework version 3.1.x',
      breadcrumbs: [
        {
