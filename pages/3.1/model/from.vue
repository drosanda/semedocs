      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              <b>From</b> method is part of <NuxtLink to="/3.1/database/query-builder">Query Builder <i class="fa fa-window-restore"></i></NuxtLink> for selecting table with its alias.
              This method support chaining method.
            </p>

            <h2>Basic Usage</h2>
            <p>
              Here is the basic usage <code>from</code> method from <code>$db</code> property on <NuxtLink to="/3.1/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink> class.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <p>
              ...
              This value are required if using the <NuxtLink to="/3.1/model/join/">Join Method <i class="fa fa-external-link"></i></NuxtLink>.
            </p>
            ...
            <div class="nav-bottom">
              <div class="nav-bottom-left">
                <nuxt-link to="/3.1/model/exec/" class="btn">
                  <i class="fa fa-chevron-left"></i>
                  Exec Method
                </nuxt-link>
              </div>
              <div class="nav-bottom-right">
                <nuxt-link to="/3.1/model/get_first/" class="btn">
                  Get First Method
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-14T00:51:01+07:00",
        "datePublished": "2021-08-14T00:51:01+07:00",
        "dateModified": "2021-08-14T00:51:01+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
