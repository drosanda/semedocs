      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>Before starting the tutorial, you have to do which is described on the <NuxtLink to="/3.1/requirements">requirements</NuxtLink> first.</p>
            ...
            <p>We assumed that you put Seme Framework which is described In the <NuxtLink to="/3.1/downloads">Download &amp; Install</NuxtLink> page.</p>
    ...
    $this-&#x3E;render();
      ...
      <div class="nav-bottom">
        <div class="nav-bottom-left">
          <nuxt-link to="/3.1/tutorial/" class="btn">
