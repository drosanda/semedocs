  ...
  <div class="section">
      <div class="container">
        ...
        <div class="content">
          ...
          <p>The following code loads and initializes the database class based on your <NuxtLink to="/3.1/config/database">configuration</NuxtLink> settings. Here the steps:</p>
          <ol>
    ...
    data (){
      return {
        ...
        breadcrumbs: [
          ...
          {
            url: (process.env.BASE_URL || 'http://localhost:3001')+'/3.1/database',
            text: 'Database'
          }
        ]
      }
