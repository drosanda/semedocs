      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>For further information how to use session using Seme Framework, please read <NuxtLink to="/id/controller/session/">how to use Session on Controller</NuxtLink>.</p>
            <hr>
