...
<li class=""><NuxtLink to="/id/">4.0.0 (Bahasa)</NuxtLink></li>
	...
	public function index(){
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/id/controller" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Controller
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/id/cli" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              CLI
            </b-button>
          </div>
        </div>
