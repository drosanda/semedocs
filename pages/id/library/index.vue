...
<li class=""><NuxtLink to="/id/">Bahasa Indonesia</NuxtLink></li>
	...
	public function index(){
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/id/controller" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Controller
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/id/cli" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              CLI
            </b-button>
          </div>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        title: 'Library - Seme Framework v4.0.0'
      }
    },
    head() {
      return {
