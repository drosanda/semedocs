  ...
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">WideImage</h1>
            <p>
              Untuk penggunaan library WideImage secara lengkap bisa membacanya melalui <a href="http://wideimage.sourceforge.net/" target="_blank">website resminya (dalam bahasa inggris) <i class="fa fa-external-link"></i></a>.
            </p>
