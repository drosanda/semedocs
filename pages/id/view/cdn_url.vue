      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              Kode <code>{{cdn_url}}</code> digunakan untuk menggantikan nilai tersebut dengan nilai yang ada pada <NuxtLink to="/4.0.0/configuration/">Pengaturan Seme Framework</NuxtLink> dalam nilai variabel <code>$cdn_url</code>.
            </p>
