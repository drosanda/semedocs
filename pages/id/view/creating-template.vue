<template>
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <b-button tag="router-link" to="/id/view" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
            View
          </b-button>
        </div>
        <div class="column is-2">&nbsp;</div>
        <div class="column">
          <b-button tag="router-link" to="/id/view/setup-header" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
            Setup header
          </b-button>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      description: 'creating view template using Seme Framework versi 4.0.0'
    }
  },
  head() {
    return {
