...
&#x9;}
        ...
        <div class="columns">
          <div class="column">
            <div class="buttons">
              <b-button tag="router-link" to="/id/model/last_id" type="is-link" icon-pack="fa" icon-left="chevron-left">
                Model::last_id
              </b-button>
              <b-button tag="router-link" to="/id/view/theme/" type="is-link" icon-pack="fa" icon-right="chevron-right">
                Create a Theme
              </b-button>
            </div>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        description: 'Pelajari selengkapnya tentang View from SENE_Controller on Seme Framework versi 4.0.0'
      }
    },
    head() {
      return {
