...
|----- col-1.php
      ...
      <div class="columns">
        <div class="column">
          <div class="buttons">
            <b-button tag="router-link" to="/id/controller/setTheme" icon-pack="fa" icon-left="chevron-left">
              setTheme Method
            </b-button>
            <b-button tag="router-link" to="/id/controller/putThemeContent" icon-pack="fa" icon-right="chevron-right">
