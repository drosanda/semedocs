      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>This method will be loaded a layout from a theme.</p>
            ...
            <p>The valid layout should only put inside <code>page</code> directory.</p>
            <pre>
...
|---- col-1.php
            ...
            <h2>Basic Usage:</h2>
            <p>Here is the basic usage of <code>Controller::loadLayout</code>.</p>
            <pre>
...
|----- col-1.php
      ...
      <div class="columns">
        <div class="column">
          <div class="buttons">
            <b-button tag="router-link" to="/id/controller/setTheme" type="is-link" icon-pack="fa" icon-left="chevron-left">
              setTheme Method
            </b-button>
            <b-button tag="router-link" to="/id/controller/putThemeContent" type="is-link" icon-pack="fa" icon-right="chevron-right">
