  ...
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">Metode cdn_url</h1>
            <p>
              Metode cdn_url ada di SENE_Controller yang berguna untuk memanggil file aset dengan URL awalan dari Content Delivery Network (CDN).
            </p>
            ...
            <p>
              Berikut ini adalah contoh potongan kode untuk penggunaan metode cdn_url pada templat view.
            </p>
