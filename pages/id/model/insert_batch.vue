  ...
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">Metode Insert Batch</h1>
            <p>
              Metode <code>insert_batch</code> adalah alias dari metode <NuxtLink to="/id/model/insert_multi/">Insert Multi <i class="fa fa-window-restore"></i></NuxtLink>.
              Adapun kegunaan metode ini adalah untuk menyisipkan beberapa baris data ke dalam suatu tabel.
            </p>

            <h2>Bentuk Umum</h2>
            <p>
              Berikut ini adalah bentuk umum metode <code>insert_batch</code> dari properti <code>$db</code> di kelas <NuxtLink to="/id/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <h2>Contoh</h2>
            <p>
              Contoh ini akan menunjukkan implementasi metode <code>insert_batch</code> pada kelas model dan kemudian bagaimana mengeksekusi metode tersebut pada kelas controller.
            </p>
            ...
            <p>
              Berikut adalah source code untuk contoh kelas controller yang menggunakan metode <code>insert_batch</code>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <p>
              Berikut ini adalah perintah SQL yang dihasilkan oleh metode yang ada pada contoh kelas <code>Blog</code> ketika mengeksekusi metode <code>insert_batch</code>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Metode Insert Batch',
      description: 'Pelajari selengkapnya tentang metode insert_batch dari properti $db di kelas SENE_Model untuk Seme Framework 4.',
      breadcrumbs: [
        {
