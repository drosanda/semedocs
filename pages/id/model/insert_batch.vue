  ...
  public function index(){
    ...
    if($res){
      ...
      echo &#x27;failed&#x27;;
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/id/model/insert_multi" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::insert_multi
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/id/model/update" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::update
            </b-button>
          </div>
        </div>
