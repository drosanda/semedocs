  ...
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">Metode Union Group By </h1>
            <p>
              Metode <code>union_group_by</code> berguna untuk melakukan perintah SQL <code>GROUP BY</code> khusus untuk Union Query Buffer.
            </p>

            <h2>Bentuk Umum</h2>
            <p>
              Berikut ini adalah bentuk umum metode <code>union_group_by</code> dari properti <code>$db</code> yang ada di kelas <code>SENE_Model</code>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <h3>$expression</h3>
            <p>
              Nilai <b>$expression</b> dapat berupa nama kolom tunggal atau dapat berupa Fungsi SQL yang kompatibel dengan perintah <code>Union Group By</code>.
            </p>

            <h2>Contoh</h2>
            <p>
              Berikut adalah implementasi kode sumber dari metode <code>union_group_by</code> di kelas model.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <div class="nav-bottom">
              <div class="nav-bottom-left">
                <nuxt-link to="/id/model/union_get/" class="btn">
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateModified": "2023-01-12T11:01:00+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
