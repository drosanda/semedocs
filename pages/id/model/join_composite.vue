      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>We can achieved the conditions of joining multiple primary key with <NuxtLink to="/id/model/composite_create/">composite_create</NuxtLink> method.</p>
...
public function getByOrderId($id){
  ...
  return $this-&#x3E;db-&#x3E;get_first();
    ...
    <div class="columns">
      <div class="column">
        <b-button tag="router-link" to="/id/model/join/" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
          Model::join
        </b-button>
      </div>
      <div class="column is-2">&nbsp;</div>
      <div class="column">
        <b-button tag="router-link" to="/id/model/composite_create" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
...
export default {
  ...
  data (){
    return {
      ...
      description: 'Pelajari selengkapnya tentang join_composite method on SENE_Model class from Seme Framework.'
    }
  },
  head() {
    return {
