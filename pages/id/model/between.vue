...
WHERE
	...
	->where("email",'andre',"and",'%like%',0,1);</pre>
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/id/model/where_as" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::where_as
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/id/model/group_by" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::group_by
            </b-button>
          </div>
        </div>
