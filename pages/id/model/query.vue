      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <h2>Bentuk Umum</h2>
            <p>
              Berikut ini adalah bentuk umum metode <code>query</code> dari properti <code>$db</code> pada kelas <NuxtLink to="/id/model/#SENE_Model">SENE_Model <i class="fa fa-window-restore"></i></NuxtLink>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
