      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>
              Metode last_id digunakan untuk mengambil ID terakhir data yang ditambahkan tabel dalam database.
              Metode ini mengembalikan nilai berupa angka (integer) positif.
              Metode ini hanya akan berjalan dengan baik apabila kolom pada table sudah disetel sebagi AUTO_INCREMENT.
            </p>
            ...
            <h2>Contoh Penggnaan</h2>
            <p>Berikut ini adalah contoh penggunaan dalam bentuk kode untuk metode last_id.</p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
                  <div class="close">
