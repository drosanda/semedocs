  ...
  <div class="section">
    <div class="container">
      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            <h1 class="">Metode Union Create</h1>
            <p>
              Metode <code>union_create</code> berguna untuk membuat kueri dari Query Builder yang ada dan disimpan pada <b>Union Query Buffer</b>.
            </p>

            <h2>Bentuk Umum</h2>
            <p>
              Berikut ini adalah bentuk umum metode <code>union_create</code> dari properti <code>$db</code> yang ada di kelas <code>SENE_Model</code>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
            ...
            <h2>Contoh</h2>
            <p>
              Pada contoh ini akan ditampilkan implementasi metode <code>union_create</code>.
            </p>
            <div class="macwindow">
              <div class="titlebar">
                <div class="buttons">
  ...
  jsonld() {
    ...
    return [
      ...
      },
      {
        ...
        "dateCreated": "2021-08-06T13:31:10+07:00",
        "datePublished": "2021-08-06T13:31:10+07:00",
        "dateModified": "2021-08-06T13:31:10+07:00",
        "author": {
          "@type": "Person",
          "gender": "Male",
