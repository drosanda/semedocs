...
&#x9; parent::__construct();
  ...
  public function getListDebugQuery($id){
    ...
    return $this-&#x3E;db-&#x3E;get(&#x27;array&#x27;,1);
        ...
        <div class="columns">
          <div class="column">
            <b-button tag="router-link" to="/id/model/limit" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::limit
            </b-button>
          </div>
          <div class="column is-2">&nbsp;</div>
          <div class="column">
            <b-button tag="router-link" to="/id/model/get_first" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::get_first
            </b-button>
          </div>
        </div>
