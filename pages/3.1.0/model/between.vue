      ...
      <div class="columns">
        ...
        <div class="nav-bottom">
          <div class="nav-bottom-left">
            <nuxt-link to="/3.1.0/model/where_as/" class="btn">
              <i class="fa fa-chevron-left"></i>
              Model::where_as
            </nuxt-link>
          </div>
          <div class="nav-bottom-right">
            <nuxt-link to="/3.1.0/model/group_by/" class="btn">
              Model::group_by
...
export default {
  ...
  data (){
    return {
      ...
      title: 'Model::between',
      description: 'Learn more about Model::between Seme Framework version 3.1.0 through this documentation.',
      breadcrumbs: [
        {
        ...
        {
          url: (process.env.BASE_URL || 'http://localhost:3001')+'/3.1.0/model/',
          text: 'Model',
        }
      ]
    }
  ...
  return [
    ...
    },
    {
      ...
      "dateModified": "2021-06-24T13:03:32+07:00",
      "author": {
        "@type": "Person",
        "gender": "Male",
