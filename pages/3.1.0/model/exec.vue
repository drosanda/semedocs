...
&#x9;}
      ...
      <div class="columns">
        <div class="column">
          <div class="buttons">
            <b-button tag="router-link" to="/3.1.0/model/delete" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Model::delete
            </b-button>
            <b-button tag="router-link" to="/3.1.0/model/query" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
              Model::query
            </b-button>
          </div>
        </div>
