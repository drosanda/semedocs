      ...
      <div class="columns">
        <div class="column">
          <div class="content">
            ...
            <p>This methode is available from SEME Framework version 3.1.4.</p>
...
&#x9; parent::__construct();
  ...
  public function update(){
    ...
    $this-&#x3E;db-&#x3E;update_as($ths-&#x3E;tbl,$du);
      ...
      <div class="columns">
        <div class="column">
          <b-button tag="router-link" to="/3.2.1/model/select" type="is-link" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
            Model::select
          </b-button>
        </div>
        <div class="column is-2">&nbsp;</div>
        <div class="column">
          <b-button tag="router-link" to="/3.2.1/model/update" type="is-link" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
            Model::update
          </b-button>
        </div>
      </div>
...
export default {
  ...
  data (){
    return {
      ...
      suffix: ' - Seme Framework v3.1.x Documentation',
      title: 'Model::update_as method',
      description: 'Learn more about update_as method from Seme Framework version 3.1.x.'
    }
  },
  head() {
    return {
