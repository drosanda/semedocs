...
location / {
	...
	try_files $uri $uri/ /index.php?$args;
      ...
      <div class="columns">
        <div class="column">
          <div class="buttons">
            <b-button tag="router-link" to="/3.1.0/configuration/" icon-pack="fa" icon-left="chevron-left" class="is-pulled-left">
              Configuration
            </b-button>
            <b-button tag="router-link" to="/3.1.0/configuration/controller" icon-pack="fa" icon-right="chevron-right" class="is-pulled-right">
